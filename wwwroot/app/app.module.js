...
const addCategory_component_1 = require("./components/orgset/addCategory/addCategory.component");
const addTeam_component_1 = require("./components/orgset/addTeam/addTeam.component");
const appRoutes = [
...
AppModule = __decorate([
    core_1.NgModule({
        imports: [platform_browser_1.BrowserModule, forms_1.FormsModule, http_1.HttpModule, material_1.MaterialModule, router_1.RouterModule.forRoot(appRoutes), ngx_datatable_1.NgxDatatableModule],
