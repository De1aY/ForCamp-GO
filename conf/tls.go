...
const (
	// Domain: "main"
	MAIN_SITE_TLS     = "./conf/tls/wplay.pem"
	MAIN_SITE_TLS_KEY = "./conf/tls/wplay_key.pem"
	...
	// Domain: "api"
	API_SITE_TLS     = "./conf/tls/api_wplay.pem"
	API_SITE_TLS_KEY = "./conf/tls/api_wplay_key.pem"
)
